            ...
            <div className="agregar-alumno-content">
                ...
                <form>
                    ...
                    <div className="button-container">
                        <button className="agregar-alumno-btn"><img src={agregarIcon} alt="Agregar" className="back-icon" />
                            Agregar Alumno</button>
                        <button className="capturar-huella-btn"><img src={huellaIcon} alt="Huella" className="back-icon" />
                            Capturar Huella</button>
